  ...
  return (
    <div className="fixed right-3 md:right-4 bottom-24 md:bottom-8 z-40 flex flex-col gap-2.5 md:gap-3" data-testid="floating-contact">
      ...
      <a data-testid="float-phone" href={`tel:${b.phone}`}
         className="h-11 w-11 md:h-12 md:w-12 grid place-items-center rounded-full bg-[#1A1A1E] border border-[#D4B77A]/50 text-[#D4B77A] shadow-lg hover:scale-105 active:scale-95 transition-transform">
