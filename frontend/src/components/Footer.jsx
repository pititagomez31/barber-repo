      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-8 text-sm text-neutral-400">
        <div>
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="font-display text-xl text-neutral-100">+58 BarberStudio</span>
          </div>
          <p>Barbería boutique en Tenerife. Estilo, precisión y respeto por tu tiempo.</p>
        </div>
        <div>
          ...
          <p className="flex gap-2 items-center mt-2"><Instagram className="h-4 w-4 text-[#D4B77A]" /> @{business?.instagram}</p>
        </div>
        <div>
          <p className="tracking-overline uppercase text-xs text-neutral-500 mb-3">Legal</p>
          <p>Política de reserva: se requiere aceptar el compromiso del 50% al reservar. Cancelaciones hasta 12 horas antes.</p>
        </div>
      </div>
