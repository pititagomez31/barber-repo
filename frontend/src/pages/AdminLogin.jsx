        ...
        <Card className="bg-[#1A1A1E] border-[#2A2A32] neumo">
          <CardContent className="p-8">
            ...
            <form onSubmit={onSubmit} className="mt-8 space-y-5">
              <div>
                <Label className="text-xs tracking-overline uppercase text-neutral-500">Usuario</Label>
                <Input data-testid="admin-username" type="text" required value={username} onChange={(e) => setUsername(e.target.value)} className="mt-2 h-12 bg-[#14141A] border-[#2A2A32]" placeholder="+58BarberStudio" autoComplete="username" />
              </div>
              <div>
